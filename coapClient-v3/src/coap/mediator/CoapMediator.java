...
public class CoapMediator {
	...
	// used by clienst to get an instance of the mediator
	...
	// used by client to send a GET-REQUEST
	...
	// used by client to send a PUT-REQUEST
	...
	// used by threads to update the map with the coap response received
