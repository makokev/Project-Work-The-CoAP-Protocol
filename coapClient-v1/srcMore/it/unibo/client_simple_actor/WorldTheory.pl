%==============================================
% WorldTheory.pl for actor client_simple_actor
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatuclient_simple_actor).	%%old version (deprecated)
actorobj(qatuclient_simple_actor).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor client_simple_actor
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of client_simple_actor" ). 
...
%-------------------------------------------------
%  User static rules about client_simple_actor
%------------------------------------------------- 
/*
------------------------------------------------------------------------
