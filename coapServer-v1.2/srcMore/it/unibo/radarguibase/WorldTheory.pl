%==============================================
% WorldTheory.pl for actor radarguibase
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qaturadarguibase).	%%old version (deprecated)
actorobj(qaturadarguibase).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor radarguibase
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of radarguibase" ). 
...
%-------------------------------------------------
%  User static rules about radarguibase
%------------------------------------------------- 
checknear( D,A):-actorPrintln( checknear( D,A)),eval( lt,D,40).
/*
------------------------------------------------------------------------
