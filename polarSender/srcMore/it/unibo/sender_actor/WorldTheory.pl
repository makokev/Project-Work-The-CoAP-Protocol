%==============================================
% WorldTheory.pl for actor sender_actor
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatusender_actor).	%%old version (deprecated)
actorobj(qatusender_actor).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor sender_actor
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of sender_actor" ). 
...
%-------------------------------------------------
%  User static rules about sender_actor
%------------------------------------------------- 
/*
------------------------------------------------------------------------
