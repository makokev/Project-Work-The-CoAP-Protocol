%==============================================
% WorldTheory.pl for actor tester
%==============================================
/*
For a QActor as a singleton statically degined in the model
*/
myname(qatutester).	%%old version (deprecated)
actorobj(qatutester).	%% see registerActorInProlog18 in QActor
...
%-------------------------------------------------
%  TuProlo FEATURES of the QActor tester
%-------------------------------------------------
dialog( FileName ) :-  
...
%% :- stdout <- println(  "hello from world theory of tester" ). 
...
%-------------------------------------------------
%  User static rules about tester
%------------------------------------------------- 
p( 80,0).
p( 80,30).
p( 30,50).
