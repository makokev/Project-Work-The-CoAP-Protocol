...
public class MediatorThreadResponse extends MediatorThread{
	...
	public MediatorThreadResponse(Socket clientSocket, int requestId, String uri) throws IOException {
	...
	public void start() {
		...
		ClientMediatorRequestID id = new ClientMediatorRequestID(requestId, uri);
